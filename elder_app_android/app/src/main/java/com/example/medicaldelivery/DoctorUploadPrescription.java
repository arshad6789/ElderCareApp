...
public class DoctorUploadPrescription extends AppCompatActivity implements JsonResponse{
    ImageButton im;
    Button b1;
    ...
    private void sendAttach() {
        try {
            ...
            //cids=Userreportemergencycase.case_id;


            String q = "http://" + Ipsettings.text + "/api/doctor_upload_prescription";
...
//            aa.put("cid",Userreportemergencycase.cids.getBytes());
            aa.put("app_id", DoctorViewAppointments.appoint_id.getBytes());
            FileUploadAsync fua = new FileUploadAsync(q);
            fua.json_response = (JsonResponse) DoctorUploadPrescription.this;
            fua.execute(aa);
        } catch (Exception e) {
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DoctorUploadPrescription.this);
